            ...
            <div className="grid md:grid-cols-3 gap-4 items-start">
              <div className="md:col-span-1">
                ...
                >
                  ...
                  <input ref={mainPhotoInputRef} type="file" accept="image/*" onChange={handleMainPhotoChange} className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" aria-label="Selecionar foto principal" />
                </div>
                {mainPhoto && (
